    ...
    public partial class SanPham : Form
    {
        ...
        private void dgvsp_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                else
                {
                    ...
                    if (File.Exists(@"C:\Users\THU BO\Desktop\XuanHa_C#\img\" + img))
                    {
                        // Hiển thị hình ảnh trong PictureBox
                        pictureBox.Image = new Bitmap(@"C:\Users\THU BO\Desktop\XuanHa_C#\img\" + img);
        ...
        private void btFile_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                string targetDirectory = @"C:\Users\THU BO\Desktop\XuanHa_C#\img\";
        ...
        private void tbMa_TextChanged_1(object sender, EventArgs e)
        {
